...
#define EXPORT_SURFACE // enables exporting surface mesh data from marching cubes algorithm to memory accessible by host
#define SURFACE_EXPORT // enables exporting surface mesh to STL files; requires SURFACE and EXPORT_SURFACE
